...
Defined in: [aws-credentials-provider.ts:59](https://github.com/boldfernando/vercel/blob/main/packages/oidc-aws-credentials-provider/src/aws-credentials-provider.ts#L59)
